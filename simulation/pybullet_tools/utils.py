...
def set_joint_position(body, joint, value):
    ...
    # p.resetJointState(body, joint, targetValue=value, physicsClientId=CLIENT)
...
def get_limits_fn(body, joints, custom_limits={}, verbose=True):
